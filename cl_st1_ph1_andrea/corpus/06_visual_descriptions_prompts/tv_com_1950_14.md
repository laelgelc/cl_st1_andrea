...
## Product context:
This is a commercial for Western Union Telegram, from the 1950s. This communication service is used for sending written messages over long distances to enable fast remote communication.
...
Audio file source: corpus/03_audio/tv_com_1950_14.wav

Transcript JSON source: corpus/04_transcripts/tv_com_1950_14.json
...
Duration: 34.0404375 seconds

Transcript metadata:

Title: Western Union Telegram
...
[0.000–7.440] Well, here's our friend the busy boss. Wow, just look at him go. People waiting to see him, big

[7.440–13.000] deal pending, lots of work to do, no time to go through the mail now. But wait, here's something

[13.000–18.840] he always makes time for, a telegram. BB likes to get telegrams and likes to send them because

[18.840–26.880] telegrams are fast, efficient, and economical. And when you answer by wire, you have a record of the

[26.880–31.900] complete transaction. Remember, when it means business, it's wise to wire.

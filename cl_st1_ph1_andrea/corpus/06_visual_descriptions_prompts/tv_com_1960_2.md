...
## Product context:
This is a commercial for IBM Selectric Typewriter, from the 1960s. This typewriter is used for typing documents to improve writing and office productivity.
...
Audio file source: corpus/03_audio/tv_com_1960_2.wav

Transcript JSON source: corpus/04_transcripts/tv_com_1960_2.json
...
[0.000–10.140] Here's a better way to put words on paper. A remarkable electric typewriter. The IBM Selectric.

[10.140–17.280] This is what makes it different. An ingenious printing element that works faster than the eye

[17.280–34.680] can see. Watch it in action. Now in slow motion as it turns, tilts, prints. The IBM Selectric is

[34.680–44.700] versatile too. From many different snap-on, snap-off elements, you can select the best type

[44.700–47.260] style for the job and be ready to print.

[47.280–57.960] Ready to type again in seconds. The IBM Selectric. A typewriter so different, only the alphabet remains the same.

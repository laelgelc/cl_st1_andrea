...
## Product context:
This is a commercial for Trans World Airlines (TWA), from 1985. This airline service is used for air travel.
...
Audio file source: corpus/03_audio/tv_com_1980_49.wav

Transcript JSON source: corpus/04_transcripts/tv_com_1980_49.json
...
Title: 1985 TWA Leading the way
...
[0.000–10.320] TWA presents the difference between getting you where you're going and leading the way.

[30.000–46.800] Taking that extra step to make flying the best it can be, that's what makes TWA one tough act to follow.

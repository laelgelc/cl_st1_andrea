\begin{textsample}{POS Dim 2 – 1950 – Score 7.00 – 1950/tv\_com\_1950\_108.txt}  \label{ex:f2_pos_073}
...
The commercial then cuts back to close-ups of mechanical components : pipes, hoses, metal fittings, and a chamber-like \textbf{device} with bolts around an opening.
...
Inside a control \textbf{room}, a man \textbf{sits} at a large console with \textbf{multiple} dials, gauges, and meters.
He faces away from the camera and appears to be operating or \textbf{monitoring} the controls.
...
In the final frame, the \textbf{screen} resolves to a clean, centered oval logo with the word “ HUMBLE ” in bold capital letters.
A visible “ OsbornTramain ” watermark appears in the lower-right area of \textbf{many} frames.

% matched lemmas: device, many, monitor, multiple, room, screen, sit
\end{textsample}

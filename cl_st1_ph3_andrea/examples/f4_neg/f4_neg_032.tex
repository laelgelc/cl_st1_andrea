\begin{textsample}{NEG Dim 4 – 1960 – Score -1.00 – 1960/tv\_com\_1960\_86.txt}  \label{ex:f4_neg_032}
...
The hand returns with the pointed tool and brings its tip toward the front of the can, aiming at the large black letters of “ ZEREX. ” The tool is pressed into the can ’s face near the middle of the label.
...
The demonstration expands into a more technical-looking setup.
...
Several streams arc to the right, some straight and \textbf{forceful}, others splashing into fine streaks and droplets.
...
The jug has a molded handle near the top and a cap, while the can is cylindrical with a metal rim.
The same black-and-silver pointed tool lies horizontally on the glossy surface in front of the packages, tying the leak-puncture demonstration back to the product display.

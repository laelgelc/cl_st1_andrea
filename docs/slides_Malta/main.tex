...
\begin{frame}[allowframebreaks]{Canonical dimension 1 structure loadings}
    \import{tables/}{cca_dimension_1_loadings.tex}
    \framebreak
    \begin{figure}[htbp]
        \centering
        ...
        %\caption{}
        %\label{}
        \includegraphics[scale=0.48]{figs/canonical_dimension_1_loadings}
        %\caption*{}
    \end{figure}
\end{frame}
}
...
\begin{frame}{Canonical dimension 2 structure loadings}
    \begin{figure}[htbp]
        ...
        %\caption{}
        %\label{}
        \includegraphics[scale=0.48]{figs/canonical_dimension_2_loadings}
        %\caption*{}
    \end{figure}
\end{frame}
}
...
\begin{frame}{Canonical dimension 3 structure loadings}
    \begin{figure}[htbp]
        ...
        %\caption{}
        %\label{}
        \includegraphics[scale=0.48]{figs/canonical_dimension_3_loadings}
        %\caption*{}
    \end{figure}
\end{frame}
}
...
\begin{frame}{Canonical dimension 4 structure loadings}
    \begin{figure}[htbp]
        ...
        %\caption{}
        %\label{}
        \includegraphics[scale=0.48]{figs/canonical_dimension_4_loadings}
        %\caption*{}
    \end{figure}
\end{frame}
}
...
\begin{frame}{Canonical dimension 5 structure loadings}
    \begin{figure}[htbp]
        ...
        %\caption{}
        %\label{}
        \includegraphics[scale=0.48]{figs/canonical_dimension_5_loadings}
        %\caption*{}
    \end{figure}
\end{frame}
}
...
\begin{frame}{Canonical dimension 6 structure loadings}
    \begin{figure}[htbp]
        ...
        %\caption{}
        %\label{}
        \includegraphics[scale=0.48]{figs/canonical_dimension_6_loadings}
        %\caption*{}
    \end{figure}
\end{frame}
}
...
\begin{frame}{Canonical dimension 7 structure loadings}
    \begin{figure}[htbp]
        ...
        %\caption{}
        %\label{}
        \includegraphics[scale=0.48]{figs/canonical_dimension_7_loadings}
        %\caption*{}
    \end{figure}
\end{frame}
}
...
\begin{frame}{Verbal Discourse Variation by Decade}
    \import{tables/}{verbal_anova.tex}
\end{frame}
}
...
\begin{frame}{Visual Discourse Variation by Decade}
    \import{tables/}{visual_anova.tex}
\end{frame}
}

%{\nologo
%\begin{frame}{Cross-Modal Discourse Variation by Decade}
%    \import{tables/}{crossmodal_anova.tex}
%\end{frame}
%}

{\nologo
\begin{frame}{Cross-Modal Discourse Variation by Decade}
    \import{tables/}{crossmodal_composite_anova.tex}
\end{frame}
}
